Otro de los operadores con el que ya te encontraste es la conjunción lógica (también llamada `and`), que solo retorna verdadero cuando las dos expresiones que opera son verdaderas.
